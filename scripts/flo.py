...
def parse_args():
    ...
    parser.add_argument('--data_dir',type=str, default='FLO', help='[AwA1 / AwA2 / CUB / FLO]')
    parser.add_argument('--img_dim', type=int, default=2048, help='the image dimension')
    parser.add_argument('--hid_dim', type=int, default=1800, help='the hidden dimension, default: 1800')
    parser.add_argument('--mid_dim', type=int, default=1600, help='the middle dimension of discriminator, default: 1600')
    parser.add_argument('--att_dim', type=int, default=1024,  help='the attribute dimension, AwA: 85, CUB: 1024,FLO: 1024')
    parser.add_argument('--cla_num', type=int, default=102, help='the class number')  # AwA: 50, CUB: 200, aPY: 32
    parser.add_argument('--tr_cla_num', type=int, default=82, help='the training class number')
    parser.add_argument('--selected_cla_num',type=int, default=5, help='the selected class number for meta-test')
    ...
    parser.add_argument('--inner_loop',type=int, default=10,help='the inner loop')
    parser.add_argument('--batch_size', type=int, default=20, help='the batch_size, default: 100')
    parser.add_argument('--manualSeed', type=int, default=8192, help='maunal seed')
...
class Model(object):
    def __init__(self,sess, args):
        ...
        print('# inner loop:', self.inner_loop)
    ...
    def F(self, x):
        ...
        with tf.name_scope('embedding'):
            hidden = tf.nn.relu(dense(x, self.img_dim, self.hid_dim)) # tanh
            if self.dropout:
    ...
    def D(self,x, c):
        with tf.name_scope('Discriminator'):
            ...
            if self.dropout:
                middle = tf.nn.dropout(middle, 0.6)
